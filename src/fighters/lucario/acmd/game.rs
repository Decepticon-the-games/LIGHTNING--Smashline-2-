use super::*;
 ...
 mod game_AttackHi4;
 mod game_AttackLw4;
 mod game_SpecialNShoot;
 mod game_SpecialAirNShoot;
 mod game_SpecialS;
 mod game_SpecialSQigong;
 mod game_SpecialSThrow;
 mod game_SpecialAirS;
 mod game_SpecialHiBound;
 mod game_SpecialHiEnd;
 mod game_SpecialAirHiEnd;
 mod game_SpecialLw;
 mod game_SpecialLwSplit;
 mod game_SpecialAirLw;
 mod game_SpecialAirAppear; 
 mod game_ThrowF;
 mod game_ThrowB;
 mod game_ThrowHi;
 mod game_ThrowLw;
  ...
  pub fn install() {
     ...
     game_SpecialNShoot::install();
     game_SpecialAirNShoot::install();
     game_SpecialS::install();
     game_SpecialSQigong::install();
     game_SpecialSThrow::install();     
     game_SpecialAirS::install();
     game_SpecialHiBound::install();
     game_SpecialHiEnd::install();    
     game_SpecialAirHiEnd::install();
     game_SpecialLw::install();
     game_SpecialLwSplit::install();     
     game_SpecialAirLw::install();
     game_SpecialAirAppear::install();   
     game_ThrowF::install();
     game_ThrowB::install();
