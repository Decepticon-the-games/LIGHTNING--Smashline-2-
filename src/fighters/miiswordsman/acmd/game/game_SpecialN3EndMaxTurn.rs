...
unsafe extern "C" fn game_specialn3endmaxturn(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("miiswordsman")
        .game_acmd("game_specialn3endmaxturn", game_specialn3endmaxturn, Priority::Low)
        .install();
}
