...
unsafe extern "C" fn game_attackstand23(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("demon")
        .game_acmd("game_attackstand23", game_attackstand23, Priority::Low)
        .install();
}
