...
unsafe extern "C" fn game_specialn1_ex(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("jack")
        .game_acmd("game_specialn1_ex", game_specialn1_ex, Priority::Low)
        .install();
}
