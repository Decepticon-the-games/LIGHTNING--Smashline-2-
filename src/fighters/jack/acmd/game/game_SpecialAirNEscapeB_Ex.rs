...
unsafe extern "C" fn game_specialairnescapeb_ex(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("jack")
        .game_acmd("game_specialairnescapeb_ex", game_specialairnescapeb_ex, Priority::Low)
        .install();
}
