...
unsafe extern "C" fn game_specialairn1_ex(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("jack")
        .game_acmd("game_specialairn1_ex", game_specialairn1_ex, Priority::Low)
        .install();
}
