...
enable_attack_cancel(fighter); 
        macros::ATTACK(fighter, 0, 0, Hash40::new("clownarmr1"), 3.0, 25, 100, 50, 0, 5.6, 7.0, 0.0, 0.0, None, None, None, 1.5, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
    ...
    if macros::is_excute(fighter) {
        ...
        lua_bind::FighterCutInManager::set_throw_finish_offset(singletons::FighterCutInManager(), Vector3f{x: 15.0, y: 5.0, z: 0.0});
    }
    frame(fighter.lua_state_agent, 15.0);
    if macros::is_excute(fighter) {
    ...
    if macros::is_excute(fighter) {
        //macros::SET_RATE_ARTICLE(fighter, *FIGHTER_KOOPAJR_GENERATE_ARTICLE_MAGICHAND, 1.176);
        fighter.clear_lua_stack();
        lua_args!(fighter, FIGHTER_KOOPAJR_GENERATE_ARTICLE_MAGICHAND, 1.176);
