use super::*;
 ...
 mod game_SpecialS;
 mod game_SpecialSSpin; 
 mod game_SpecialSLanding;
 mod game_SpecialAirS;
 mod game_SpecialAirSSpin;
 mod game_SpecialHiJrAttack;
 mod game_SpecialHiJrRise;
 mod game_SpecialLw;
 ...
 mod game_ThrowLw;
  ...
  pub fn install() {
    ...
    game_SpecialSSpin::install(); 
    game_SpecialSLanding::install();
    game_SpecialAirS::install();
    game_SpecialAirSSpin::install();
    game_SpecialHiJrAttack::install();
    game_SpecialHiJrRise::install();
