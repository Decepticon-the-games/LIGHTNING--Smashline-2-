...
unsafe extern "C" fn game_specialairsthrowlw(fighter: &mut L2CAgentBase) {
...
whiff_cancel(fighter);
        ...
        KineticModule::add_speed(fighter.module_accessor, &Vector3f{x: 0.0, y: 2.3, z: 0.0});
    }
}    

pub fn install() {
    Agent::new("shizue")
        .game_acmd("game_specialairsthrowlw", game_specialairsthrowlw, Priority::Low)
        .install();
}
