...
unsafe extern "C" fn game_specials1end(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("miifighter")
        .game_acmd("game_specials1end", game_specials1end, Priority::Low)
        .install();
}
