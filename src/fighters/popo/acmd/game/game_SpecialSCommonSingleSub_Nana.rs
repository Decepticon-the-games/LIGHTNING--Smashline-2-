...
unsafe extern "C" fn game_specialscommonsinglesub_nana(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("popo")
        .game_acmd("game_specialscommonsinglesub_nana", game_specialscommonsinglesub_nana, Priority::Low)
        .install();
}
