...
unsafe extern "C" fn game_specialsattacksinglefsub(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("popo")
        .game_acmd("game_specialsattacksinglefsub", game_specialsattacksinglefsub, Priority::Low)
        .install();
}
