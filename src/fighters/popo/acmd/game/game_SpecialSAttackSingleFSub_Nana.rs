...
unsafe extern "C" fn game_specialsattacksinglefsub_nana(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("popo")
        .game_acmd("game_specialsattacksinglefsub_nana", game_specialsattacksinglefsub_nana, Priority::Low)
        .install();
}
