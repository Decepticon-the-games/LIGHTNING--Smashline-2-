use super::*;
 ...
 mod game_SpecialNEndHi;
 mod game_SpecialNEndLw;
 mod game_SpecialNEndMax;
 mod game_SpecialNEndMaxHi;
 mod game_SpecialNEndMaxLw;

 mod game_SpecialAirNEnd;
 mod game_SpecialAirNEndHi;
 mod game_SpecialAirNEndLw;
 mod game_SpecialAirNEndMax;
 mod game_SpecialAirNEndMaxHi;
 mod game_SpecialAirNEndMaxLw; 

 mod game_SpecialS1;
 mod game_SpecialS2Hi;
 mod game_SpecialS2Lw;
 mod game_SpecialS3Hi;
 mod game_SpecialS3Lw;
 mod game_SpecialS3S;
 ...
 mod game_ThrowLw;
  ...
  pub fn install() {
     ...
     game_SpecialNEndHi::install();
     game_SpecialNEndLw::install();
     game_SpecialNEndMax::install();
     game_SpecialNEndMaxHi::install();
     game_SpecialNEndMaxLw::install();
    
     game_SpecialAirNEnd::install();
     game_SpecialAirNEndHi::install();
     game_SpecialAirNEndLw::install();
     game_SpecialAirNEndMax::install();
     game_SpecialAirNEndMaxHi::install();
     game_SpecialAirNEndMaxLw::install(); 
    
     game_SpecialS1::install();
     game_SpecialS2Hi::install();
     game_SpecialS2Lw::install();
     game_SpecialS3Hi::install();
     game_SpecialS3Lw::install();
     game_SpecialS3S::install();
