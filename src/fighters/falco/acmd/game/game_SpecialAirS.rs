...
let down_inputs = ((cat1 & *FIGHTER_PAD_CMD_CAT1_FLAG_ATTACK_LW3) != 0 )
    ...
    if macros::is_excute(fighter) {
        if up_inputs {
            ...
            macros::ATTACK(fighter, 1, 0, Hash40::new("body"), 0.0, 361, 0, 0, 0, 3.0, 0.0, 10.0, 12.0, None, None, None, 1.0, 0.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_search"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_NONE);
        }
        else if down_inputs {
            enable_attack_cancel(fighter);
