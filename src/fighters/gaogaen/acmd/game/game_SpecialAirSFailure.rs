...
pub fn install() {
    Agent::new("gaogaen")
        .game_acmd("game_specialairsfailure", game_specialairsfailure, Priority::Low)
        .install();
}
