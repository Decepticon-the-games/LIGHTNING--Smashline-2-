use super::*;
 ...
 mod game_SpecialAirSKick;
 mod game_SpecialSStickAttack;
 mod game_SpecialSStickJump; 
 mod game_SpecialAirHiJump;
 mod game_SpecialLw;
 ...
 mod game_ThrowLw;
  ...
  pub fn install() {
     ...
     game_SpecialAirSKick::install();
     game_SpecialSStickAttack::install();
     game_SpecialSStickJump::install();
     game_SpecialAirHiJump::install();
