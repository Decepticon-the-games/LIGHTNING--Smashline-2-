...
unsafe extern "C" fn game_specialhithrownana_nana(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("nana")
        .game_acmd("game_specialhithrownana_nana", game_specialhithrownana_nana, Priority::Low)
        .install();
}
