...
unsafe extern "C" fn game_attackairlw_nana(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("nana")
        .game_acmd("game_attackairlw_nana", game_attackairlw_nana, Priority::Low)
        .install();
}
