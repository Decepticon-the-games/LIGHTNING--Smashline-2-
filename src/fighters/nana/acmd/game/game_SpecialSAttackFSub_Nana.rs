...
unsafe extern "C" fn game_specialsattackfsub_nana(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("nana")
        .game_acmd("game_specialsattackfsub_nana", game_specialsattackfsub_nana, Priority::Low)
        .install();
}
