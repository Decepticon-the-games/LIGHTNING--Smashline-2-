...
unsafe extern "C" fn game_specialsattacksinglebsub_nana(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("nana")
        .game_acmd("game_specialsattacksinglebsub_nana", game_specialsattacksinglebsub_nana, Priority::Low)
        .install();
}
