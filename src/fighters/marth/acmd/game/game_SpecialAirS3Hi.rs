...
unsafe extern "C" fn game_specialairs3hi(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("marth")
        .game_acmd("game_specialairs3hi", game_specialairs3hi, Priority::Low)
        .install();
}
