...
unsafe extern "C" fn game_specialairs2lw(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("marth")
        .game_acmd("game_specialairs2lw", game_specialairs2lw, Priority::Low)
        .install();
}
