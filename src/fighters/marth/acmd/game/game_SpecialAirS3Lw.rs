...
unsafe extern "C" fn game_specialairs3lw(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("marth")
        .game_acmd("game_specialairs3lw", game_specialairs3lw, Priority::Low)
        .install();
}
