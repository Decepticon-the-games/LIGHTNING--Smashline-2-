use super::*;
 ...
 mod game_AttackAirN;
 mod game_AttackAirF;
 mod game_AttackAirFHi;
 mod game_AttackAirFLw;
 mod game_AttackAirB;
 mod game_AttackAirBHi;
 mod game_AttackAirBLw;
 ...
 mod game_ThrowLw;
  ...
  pub fn install() {
     ...
     game_AttackAirFHi::install();
     game_AttackAirFLw::install();
     game_AttackAirB::install();
     game_AttackAirBHi::install();
     game_AttackAirBLw::install();
