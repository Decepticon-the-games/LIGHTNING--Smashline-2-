...
macros::ATTACK(fighter, 0, 0, Hash40::new("top"), 12.0, 361, 55, 0, 80, 2.3, 0.0, 23.0, 38.0, None, None, None, 0.8, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_whip"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_SIMON_WHIP, *ATTACK_REGION_WHIP);
...
pub fn install() {
    Agent::new("richter")
        .game_acmd("game_attackairfhi", game_attackairfhi, Priority::Low)
        .install();
}
