...
macros::ATTACK(fighter, 0, 0, Hash40::new("top"), 17.0, 80, 103, 0, 31, 6.4, 0.0, 4.2, 7.7, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_fire"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_FIRE, *ATTACK_REGION_BOMB);
    ...
    if macros::is_excute(fighter) {
        macros::ATK_POWER(fighter, 0, 14);
        macros::ATK_POWER(fighter, 1, 14);
        ...
        macros::ATTACK(fighter, 3, 0, Hash40::new("top"), 14.0, 60, 106, 0, 20, 4.3, 0.0, 15.0, -8.5, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_fire"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_FIRE, *ATTACK_REGION_BOMB);
    }
