...
pub fn install() {
    Agent::new("szerosuit")
        .game_acmd("game_specialairlwflip", game_specialairlwflip, Priority::Low)
        .install();
}
