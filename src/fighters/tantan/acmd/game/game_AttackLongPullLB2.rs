...
unsafe extern "C" fn game_attacklongpulllb2(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("tantan")
        .game_acmd("game_attacklongpulllb2", game_attacklongpulllb2, Priority::Low)
        .install();
}
